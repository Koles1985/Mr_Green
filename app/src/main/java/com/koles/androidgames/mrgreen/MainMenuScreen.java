        ...
        for(int i = 0; i < len; i++){
            ...
            if(event.type == TouchEvent.TOUCH_UP) {
                if (inBounds(event, 0, g.getHeight() - 64, 64, 64)) {
                    ...
                    return;
                }//close if (inBounds(event, 0, g.getHeight() - 64, 64, 64))
                if(inBounds(event, 64, 220, 192, 42)){
                    ...
                    return;
                }//close if(inBounds(event, 64, 220, 192, 42))
                ...
                if(inBounds(event, 64, 220 + 42, 192, 42)){
                    ...
                    return;
                }//close if(inBounds(event, 64, 220 + 42, 192, 42))
                ...
                if(inBounds(event, 64, 220 + 84, 192, 42)){
                    ...
                    return;
                }//close  if(inBounds(event, 64, 220 + 84, 192, 42))
            }//close  if(event.type == TouchEvent.TOUCH_UP)
        }//close  for(int i = 0; i < len; i++)
    }//close method update
