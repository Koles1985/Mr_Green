package com.koles.androidgames.view;
...
import com.koles.androidgames.model.Snake;
import com.koles.androidgames.model.SnakePart;
import com.koles.androidgames.model.Stain;
import com.koles.androidgames.model.World;
import com.koles.androidgames.mrgreen.Assets;
import com.koles.androidgames.mrgreen.MainMenuScreen;
import com.koles.androidgames.mrgreen.Settings;
            ...
            if(event.type == TouchEvent.TOUCH_UP){
                if(event.x < 64 && event.y < 64){
                    if(Settings.soundEnabled){
                        Assets.click.play(1);
                    }//close if(Settings.soundEnabled)
                    state = GameState.Paused;
                    return;
                }//close if(event.x < 64 && event.y < 64)
            ...
            if(event.type == TouchEvent.TOUCH_UP){
                if(event.x > 80 && event.x <= 240 ){
                    if(event.y > 100 && event.y <= 148){
                        ...
                        state = GameState.Running;
                        return;
                    }//close  if(event.y > 100 && event.y <= 148)
                    ...
                    if(event.y > 148 && event.y < 196){
                        ...
                        return;
                    }//close if(event.y > 148 && event.y < 196)
                }// close  if(event.x > 80 && event.x <= 240 )
            }//close if(event.type == TouchEvent.TOUCH_UP)
        }//close for
    }//close method updatePaused()
